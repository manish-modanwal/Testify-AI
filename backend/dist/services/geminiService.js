...
exports.getFileLanguage = exports.generateCodeFromSummary = exports.generateTestSummaries = void 0;
...
const getPromptText = (type, language, framework) => {
 ...
 */
const generateTestSummaries = (files, language, framework) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const file of files) {
        ...
        try {
            ...
            const summaryObject = JSON.parse(cleanedText);
...
exports.generateTestSummaries = generateTestSummaries;
const generateCodeFromSummary = (fileContent, fileName, summary, language, framework) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.generateCodeFromSummary = generateCodeFromSummary;
